 ...
 *
 * <p>
 * This sample will be invoked for any terminals selecting AIDs of 0xF123344556,
 * See src/main/res/xml/aid_list.xml for more
 * details.
 *
 * <p class="note">
...
public class CardService extends HostApduService {
	...
	private static final String SAMPLE_LOYALTY_CARD_AID = "F123344556";
	private static  byte[] SELECT_APDU={0}; //BuildSelectApdu(SAMPLE_LOYALTY_CARD_AID);
	// ISO-DEP command HEADER for selecting an AID.
	// Format: [Class | Instruction | Parameter 1 | Parameter 2]
	private static final String SELECT_APDU_HEADER = "00A40400";
	// "OK" status word sent in response to SELECT AID command (0x9000)
	private static final byte[] SELECT_OK_SW = HexStringToByteArray("aaaa");
	private static final String TAG = "CardService";
	// "UNKNOWN" status word sent in response to invalid APDU command (0x0000)
	private static final byte[] UNKNOWN_CMD_SW = HexStringToByteArray("AA01");
	...
	public void onCreate(){
		SELECT_APDU= BuildSelectApdu(SAMPLE_LOYALTY_CARD_AID);
		Log.e(TAG, "--------onCreate--------"); 
		super.onCreate();
	...
	public void onDestroy(){
		Log.e(TAG, "--------onDestroy--------"); 
		super.onDestroy();
	//	SELECT_APDU= BuildSelectApdu("F2233445566");
	}
	@Override
