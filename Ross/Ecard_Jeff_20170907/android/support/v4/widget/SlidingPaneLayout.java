...
public class SlidingPaneLayout extends ViewGroup
{
  ...
  protected void onMeasure(int paramInt1, int paramInt2)
  {
    ...
    label392: paramInt1 = localLayoutParams.leftMargin + localLayoutParams.rightMargin;
    if (localLayoutParams.width == -2)
    {
      paramInt1 = View.MeasureSpec.makeMeasureSpec(k - paramInt1, -2147483648);
      label425: if (localLayoutParams.height != -2)
        break label606;
      j = View.MeasureSpec.makeMeasureSpec(paramInt2, -2147483648);
      label444: localView.measure(paramInt1, j);
    ...
    label643: for (boolean bool2 = true; ; bool2 = false)
    {
      ...
      break label425;
      label606: if (localLayoutParams.height == -1)
      {
      ...
      if (j < i3)
      {
        ...
        while (true)
        {
          ...
          if (localView.getVisibility() != 8)
            ...
            {
              paramInt1 = 1;
              label746: if (paramInt1 != 0)
              {
                n = 0;
                label753: if ((!bool1) || (localView == this.mSlideableView))
                  break label896;
            ...
            else
            {
              while (true)
              {
                ...
                break label753;
                label846: if (localLayoutParams.height == -1)
                {
                ...
                else
                {
                  ...
                  continue;
                  label881: paramInt1 = View.MeasureSpec.makeMeasureSpec(localView.getMeasuredHeight(), 1073741824);
                }
              }
              if (localLayoutParams.weight > 0.0F)
              {
    ...
    label896: label1031: setMeasuredDimension(k, i);
...
/* Location:           E:\Install\cardemulator\classes-dex2jar.jar
